    ...
    calculaDelta(desejado, iNeuronio, iCamada) {
        ...
        if (this.delta[iCamada]) {
            if (this.delta[iCamada + 1]) {
                ...
                this.delta[iCamada][iNeuronio] = (desejado - this.ativacao[iCamada][iNeuronio]) * this.derivada(this.ativacao[iCamada][iNeuronio])
...
console.log(JSON.stringify(bp.pesos))